...
string getFingerCapture(PT_DATA io_px_data);
...
int devStatus=-1;
	...
	{
		Nan::HandleScope scope;
		string fp=getFingerCapture(&l_x_data);
		cout<<fp<<endl;
		info.GetReturnValue().Set(Nan::New<String>(fp).ToLocalChecked());
	}
